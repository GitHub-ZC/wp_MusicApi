let MD5 = function (a) {
    ...
    function c(a) {
        for (var b = [
        ], c = 0; c < a.length; c++) b = b.concat(k(a[c]));
        return b
    }
    function d(a) {
        for (var b = [
        ], c = 0; 8 > c; c++) b.push(255 & a),
            a >>>= 8;
        return b
    }
    function e(a, b) {
    ...
    function k(a) {
        for (var b = [
        ], c = 0; c < a.length; c++) if (a.charCodeAt(c) <= 127) b.push(a.charCodeAt(c));
            else for (var d = encodeURIComponent(a.charAt(c)).substr(1).split('%'), e = 0; e < d.length; e++) b.push(parseInt(d[e], 16));
        return b
    }
    function l() {
        for (var a = '', c = 0, d = 0, e = 3; e >= 0; e--) d = arguments[e],
            c = 255 & d,
            d >>>= 8,
            c <<= 8,
            c |= 255 & d,
