...
// var bKB5G = window.asrsea(JSON.stringify(i2x), buV2x(["流泪", "强"]), buV2x(Rg8Y.md), buV2x(["爱心", "女孩", "惊恐", "大笑"]));
// data = j2x.cr3x({
...
// 格式化参数
var buV2x = function (chL9C) {
    var m2x = [];
    bg3x(chL9C, function (chE9v) {
        m2x.push(emj[chE9v])
    });
    return m2x.join("")
};
...
var bg3x = function (k2x, cG3x, O2x) {
...
var gV5a = function (i2x) {
    return JW6Q(i2x, "function")
}



var JW6Q = function (i2x, v2x) {
    try {
        v2x = v2x.toLowerCase();
        if (i2x === null)
            return v2x == "null";
        ...
        return {}.toString.call(i2x).toLowerCase() == "[object " + v2x + "]"
    } catch (e) {
        return !1
    }
};
...
module.exports = {
    s: (ids, br) => {
        ...
        let data = asrsea(JSON.stringify(i2x), buV2x(["流泪", "强"]), buV2x(md), buV2x(["爱心", "女孩", "惊恐", "大笑"]));
